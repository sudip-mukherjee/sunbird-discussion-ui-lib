export const urlConfig = {
    ...
    fetchProfile: (slug: string) => `discussionHub/users/${slug}/about`,
    listUpVote: (slug: string) => `/discussionHub/users/${slug}/upvoted`,
    listDownVoted: (slug: string) => `discussionHub/users/${slug}/downvoted`,
    listSaved: (slug: string) => `discussionHub/users/${slug}/bookmarks`,
